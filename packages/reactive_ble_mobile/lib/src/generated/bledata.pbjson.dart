...
final $typed_data.Uint8List getConnectionRequestDescriptor = $convert.base64Decode(
    'ChRHZXRDb25uZWN0aW9uUmVxdWVzdBIaCghkZXZpY2VJZBgBIAEoCVIIZGV2aWNlSWQ=');

@$core.Deprecated('Use getConnectionInfoDescriptor instead')
const GetConnectionInfo$json = {
  '1': 'GetConnectionInfo',
  '2': [
...
/// Descriptor for `GetConnectionInfo`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getConnectionInfoDescriptor = $convert.base64Decode(
    'ChFHZXRDb25uZWN0aW9uSW5mbxIUCgVzdGF0ZRgBIAEoCFIFc3RhdGU=');

@$core.Deprecated('Use btMacAddressInfoDescriptor instead')
...
final $typed_data.Uint8List btMacAddressInfoDescriptor = $convert.base64Decode(
    ...
    'RlbGV0ZRgCIAEoCFILZm9yY2VEZWxldGU=');

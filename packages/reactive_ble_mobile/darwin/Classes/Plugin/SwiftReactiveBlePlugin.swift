...
public class SwiftReactiveBlePlugin: NSObject, FlutterPlugin {
    ...
    public static func register(with registrar: FlutterPluginRegistrar) {
        ...
        FlutterEventChannel(name: "flutter_reactive_ble_connected_central", binaryMessenger: messenger)
            .setStreamHandler(plugin.connectedCentralStreamHandler)
        FlutterEventChannel(name: "flutter_reactive_ble_char_update_central", binaryMessenger: messenger)
    ...
    private let methodHandler = MethodHandler<PluginController>([
        ...
        AnyPlatformMethod(UnaryPlatformMethod(name: "removeInetBoxBonding") { (name, context, completion) in
            context.removeInetBoxBonding(name: name, args: args, completion: completion)
        }),
    ])

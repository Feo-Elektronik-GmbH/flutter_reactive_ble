...
extension Uuid: @unchecked Sendable {}
extension GenericFailure: @unchecked Sendable {}
extension GetConnectionRequest: @unchecked Sendable {}
extension GetConnectionInfo: @unchecked Sendable {}
extension BtMacAddressInfo: @unchecked Sendable {}
#endif  // swift(>=5.5) && canImport(_Concurrency)
...
extension GetConnectionInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = "GetConnectionInfo"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "state"),
  ]
...
extension BtMacAddressInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
